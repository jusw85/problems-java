...
public class PowerOfThor1 {
    ...
    public static void main(String args[]) {
        ...
        while (true) {
            ...
            int movX = currX > lightX ? -1 : (currX < lightX ? 1 : 0);
            int movY = currY > lightY ? -1 : (currY < lightY ? 1 : 0);
            currX += movX;
            currY += movY;
            System.out.print(movY > 0 ? "S" : (movY < 0 ? "N" : ""));
            System.out.println(movX > 0 ? "E" : (movX < 0 ? "W" : ""));
        }
    }
}
