...
public class Day3 {
    ...
    public static Pattern p = Pattern.compile("#(\\d+) @ (\\d+),(\\d+): (\\d+)x(\\d+)");

    public static void main(String[] args) throws FileNotFoundException {
        Scanner sc = new Scanner(new File("./etc/aoc2018/in3"));

        List<Integer>[][] grid = new ArrayList[1200][1200];
