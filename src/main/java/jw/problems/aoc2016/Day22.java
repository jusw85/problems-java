...
public class Day22 {
    ...
    public static Pattern p = Pattern.compile("/dev/grid/node-x(\\d+)-y(\\d+)\\s+(\\d+)T\\s+(\\d+)T\\s+(\\d+)T\\s+(\\d+)%");

    public static void main(String[] args) throws FileNotFoundException {
        Scanner sc = new Scanner(new File("./etc/aoc2016/in22"));
        sc.nextLine();
        sc.nextLine();
        ...
        while (sc.hasNextLine()) {
            ...
            int usedPerc = Integer.parseInt(m.group(6));
            nodes.add(new Node(x, y, size, used, avail, usedPerc));
        }
        printNodes(nodes);
        printMap(nodes);
    }
     ...
     * ...................................
     * ........_..........................
     * ans = 7 + 28 + 32 + (5*33) + 1 = 233
     */
    public static void printMap(List<Node> nodes) {
        char[][] map = new char[29][35];
        for (Node n : nodes) {
            int y = n.y;
            int x = n.x;
            if (n.used == 0) {
    ...
    public static void printNodes(List<Node> nodes) {
        Collections.sort(nodes, Comparator.comparingInt(o -> o.used));
        for (Node n : nodes) {
    ...
    public static class Node {
        ...
        public Node(int x, int y, int size, int used, int avail, int usedPerc) {
            this.x = x;
            this.y = y;
            this.size = size;
            this.used = used;
        ...
        public String toString() {
            ...
            sb.append(", usedPerc=").append(usedPerc);
            sb.append('}');
            return sb.toString();
        }
    }
