...
public class Day25 {
    ...
    public static Point parseInput(String inFile) throws FileNotFoundException {
        Scanner sc = new Scanner(new File(inFile));
        int y = Integer.parseInt(sc.findInLine("\\d+"));
        int x = Integer.parseInt(sc.findInLine("\\d+"));
        return new Point(x, y);
    }

    public static void main(String[] args) throws FileNotFoundException {
        Point xy = parseInput("./etc/aoc2015/in25");
        xy.x--;
        xy.y--;
        int x = 0;
        int y = 0;
    ...
    public static long nextNum(long in) {
